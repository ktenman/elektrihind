...
public class RedisConfig {
    ...
    public static final String ONE_DAY_CACHE_1 = "one-day-cache-1d";
    public static final String ONE_DAY_CACHE_2 = "one-day-cache-2d";
    public static final String ONE_DAY_CACHE_3 = "one-day-cache-3d";
    public static final String ONE_DAY_CACHE_4 = "one-day-cache-44d";
    public static final String ONE_MONTH_CACHE_1 = "one-day-month_1d";
    public static final String ONE_MONTH_CACHE_2 = "one-day-month_2d";
    public static final String ONE_MONTH_CACHE_3 = "one-day-month_3d";
    public static final String ONE_MONTH_CACHE_4 = "one-day-month_4d";
    public static final String ONE_MONTH_CACHE_5 = "thirty-days-cache-3d";
    public static final String ONE_YEAR_CACHE_1 = "one-year-cache-1d";
    public static final String ONE_YEAR_CACHE_2 = "one-year-cache-2d";
    public static final String MESSAGE_COUNTS_CACHE = "message-counts-cache-1d";
